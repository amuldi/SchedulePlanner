...
[배포 사이트 바로가기](https://design-schedule-deploy.vercel.app)
...
![SchedulePlanner favicon](./assets/readme/favicon-preview.png)

favicon과 앱 아이콘은 캘린더 카드, `S` 모노그램, 체크 포인트를 조합해 일정 관리 앱의 성격이 작게 보여도 드러나도록 디자인했습니다.
